    ...
    <div className="mobile-home-app">
      ...
      <section className="featured-section">
        <div className="section-header">
          ...
          <Link href="/mobile-app/catalog" className="see-all-link">
            Все парковки
      ...
      <section className="map-section">
        <div className="section-header">
          ...
          <Link href="/mobile-app/map" className="see-all-link">
            Открыть карту
            <span className="arrow">→</span>
          </Link>
        </div>
      ...
      <section className="cta-section-app">
        <div className="cta-content">
          ...
          <div className="cta-buttons">
            <Link href="/mobile-app/register" className="cta-primary">
              Зарегистрироваться
            </Link>
            <Link href="/mobile-app/login" className="cta-secondary">
              Войти в аккаунт
            </Link>
          </div>
        </div>
